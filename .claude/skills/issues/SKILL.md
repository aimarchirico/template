...
metadata:
    ...
    github-tree-sha: ac5d4c69b456326dc3a08b1692d79dadacf4db03
name: issues
---
## When to Use
...
1. Preflight: Verify that `CONTRIBUTING.md` exists in the repository root and the `.github/ISSUE_TEMPLATE/` directory exists. If any are missing, run `npx @aimarchirico/commons-docs materialize-templates` to materialize the documentation.
