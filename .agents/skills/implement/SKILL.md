...
7. Execute `git push -u origin <branch-name>` to push the commits to the remote repository.
8. Execute the `pr` skill to open a pull request. Pass the --draft flag to the `pr` skill if it was provided by the user.
