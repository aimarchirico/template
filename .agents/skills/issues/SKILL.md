...
1. Preflight: Verify that `CONTRIBUTING.md` exists in the repository root and the `.github/ISSUE_TEMPLATE/` directory exists. If any are missing, halt execution and notify the user.
