...
<html>
	<style>  @media (prefers-color-scheme: dark) {    .auto-invert { filter: invert(1) hue-rotate(180deg); }  }			</style><img src="[drawing.excalidraw.svg](https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" class="auto-invert">
</html>
